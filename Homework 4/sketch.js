...
var onionSpeed = -18;
var onionTimer = 0;
var onionInterval = 30;

// sticker
var stickerX = 700;
var stickerBaseY = 260;
var stickerRange = 80;
...
function preload() {
    greenOnionImg = loadImage('assets/images/greenOnion.png');
    mikuStickerImg = loadImage('assets/images/miku_waveSticker.png');
    mikuAIImg = loadImage('assets/images/ai_generatedMiku.png');
    font = loadFont('assets/font/PopHappinessStd-EB.ttf');
}
function setup() 
{
...
image(greenOnionImg, onionX, onionY,80 ,80);
image(mikuAIImg, aiX, aiY, 200, 200);

var stickerY = stickerBaseY + sin(frameCount * 0.05) * stickerRange;
  image(mikuStickerImg, stickerX, stickerY, 120, 120);
